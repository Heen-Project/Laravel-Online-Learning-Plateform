  ...
  <ul>
    ...
    <li>
      ...
      <ul>
        ...
        <li>
         <a href="{{action('AdminController@closeDiscussion', $discussion->id)}}"><button class=" adminButton font" style="width:99%"> {{ trans('dictionary.close_discussion') }} </button></a>
       </li>
       <li>
         <a href="{{action('AdminController@deleteDiscussion', $discussion->id)}}"><button class=" adminButton font" style="width:99%"> {{ trans('dictionary.delete_discussion') }} </button></a>
       </li>
       @endif
     </ul> 
   </li>
