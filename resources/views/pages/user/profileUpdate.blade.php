...
<h1>{{$userLocal->username}}'s {{trans('dictionary.profile_update')}}</h1>
	...
	{!! Form::submit(trans('dictionary.save'), ['class'=>'userLightColor userButton font', 'style'=>'width:45%; display:inline-block']) !!}
	{!! Form::reset(trans('dictionary.reset'), ['class'=>'userLightColor userButton font', 'style'=>'width:45%; display:inline-block']) !!}
	{!! Form::close() !!}
@stop